...
let Address = (() => {
    ...
    (() => {
        ...
        _pin_code_decorators = [(0, sequelize_typescript_1.Column)({
                type: sequelize_1.DataTypes.STRING,
                allowNull: false,
            })];
        ...
        _userId_decorators = [(0, sequelize_typescript_1.ForeignKey)(() => user_1.User), (0, sequelize_typescript_1.Column)({
